...
class _$UtilisateurTearOff {
  ...
  _Utilisateur call(
      @JsonKey(name: '\$id') String uid, String name, String email) {
    return _Utilisateur(
      uid,
      name,
      email,
...
abstract class $UtilisateurCopyWith<$Res> {
  ...
  $Res call({@JsonKey(name: '\$id') String uid, String name, String email});
}
...
class _$_Utilisateur implements _Utilisateur {
  _$_Utilisateur(@JsonKey(name: '\$id') this.uid, this.name, this.email);
